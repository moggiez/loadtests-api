terraform {
  ...
  backend "s3" {
    ...
    key            = "loadtests-api-terraform.state"
    region         = "eu-west-1"
    dynamodb_table = "moggies.io-loadtests-api-terraform_state"
  }
}
...
resource "aws_api_gateway_rest_api" "_" {
  name        = "loadtests-api"
  description = "loadtests-api API"
}


resource "aws_api_gateway_authorizer" "_" {
  name          = "loadtests-api-UserAuthorizer"
